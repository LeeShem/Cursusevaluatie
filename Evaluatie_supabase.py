...
VRAGEN_DC = {
    ...
    "2 - Verwerking": [
        ...
        ("Het zwaartepunt van de opdracht ligt aantoonbaar op 'Toepassen' of 'Evalueren' (de student moet iets doen met de kennis, niet alleen reproduceren).", 1, "Bloom"),
    ...
    "3 - Zelfstudie & Literatuur": [
        ...
        ("De totale hoeveelheid te bestuderen stof is realistisch in verhouding tot de formele studiebelastingsuren.", 1, "Biggs"),
        ...
        ("In de opdracht tot zelfstudie zit een vraagstuk of contextbeschrijving die de student dwingt om eerst zijn/haar voorkennis op te halen voordat het lezen begint.", 2, "Gagné"),
        ...
        ("De literatuur is geschreven voor (of logisch te vertalen naar) de ALO-context, en is geen algemene psychologie of theorie zonder link naar de praktijk.", 3, "Shulman PCK"),
        ("De leesopdracht vraagt de student expliciet om tijdens het lezen de theorie (concepten) te koppelen aan een eigen praktijkervaring.", 3, "Kolb"),
    ...
    "4 - Digitale Tools & Oefenmateriaal": [
        ("Het denkniveau van de oefenvragen/opdrachten bereidt de student direct voor op de mate van complexiteit van het tentamen.", 1, "Biggs"),
        ...
        ("De tool wordt gebruikt om de vertaling naar de praktijk te oefenen ('Knows How'); de student moet de theorie toepassen om een geschetst praktijkprobleem te analyseren of een handeling te kiezen.", 3, "Miller"),
        ("De tool vraagt de student om diverse praktijksituaties te analyseren en deze expliciet te verbinden met theoretische concepten, waardoor de student leert om losse situaties te categoriseren onder de juiste theorie.", 3, "Kolb"),
    ...
    "5 - Beroepspraktijk": [
        ...
        ("De opdracht eist dat de student zelf een beroepshandeling uitvoert of analytisch onderbouwt (waarom doe ik dit?), in plaats van uitsluitend een bestaand plan uit te voeren.", 1, "Bloom"),
...
RUBRIC_DC = {
    ...
    ("1 - Instructie", 2): "Gagné: De les start expliciet met een prikkelende 'hook' om de aandacht te vangen, het benoemen van het leerdoel, en dwingt de student direct om relevante voorkennis of ervaringen te activeren.\n\nContext-concept: De theorie-uitleg begint met een herkenbaar praktijkprobleem. (i.p.v. droge definities).\n\nScaffolfing: Complexe theorie wordt op de slides in visueel behapbare stappen aangeboden. (chunks).",
    ...
    ("2 - Verwerking", 1): "Dublin: Opdracht vereist gebruik van academische hbo-vaardigheden.\n\nBloom: et zwaartepunt van de opdracht ligt aantoonbaar op 'Toepassen' of 'Evalueren' (de student moet iets doen met de kennis, niet alleen reproduceren)..",
    ...
    ("4 - Digitale Tools & Oefenmateriaal", 3): "Miller: De tool wordt gebruikt om de vertaling naar de praktijk te oefenen ('Knows How'); de student moet de theorie toepassen om een geschetst praktijkprobleem te analyseren of een handeling te kiezen.\n\nKolb: De tool vraagt de student om diverse praktijksituaties te analyseren en deze expliciet te verbinden met theoretische concepten, waardoor de student leert om losse situaties te categoriseren onder de juiste theorie.",
    ...
    ("5 - Beroepspraktijk", 1): "Biggs: Weging stage-opdracht expliciet vastgelegd.\n\nBloom: De opdracht eist dat de student zelf een beroepshandeling uitvoert of analytisch onderbouwt (waarom doe ik dit?), in plaats van uitsluitend een bestaand plan uit te voeren.",
    ("5 - Beroepspraktijk", 2): "Scaffolding: Instructie bevat concrete focuspunten en kijkwijzer.\n\nDe leerroute is inductief: de opdracht start met een authentiek praktijkscenario (observatie, casus of simulatie) dat een duidelijke leervraag oproept; de theorie (het concept) wordt pas aangereikt wanneer de relevantie voor de praktijk is aangetoond.",
    ("5 - Beroepspraktijk", 3): "Kolb: De opdracht borgt in de stappen dat de volledige leercyclus wordt doorlopen: ervaring opdoen, reflecteren, theorie koppelen, en een nieuw plan maken.\n\nKolb: Er is een verplicht, aantoonbaar moment waarop de student de theorie bespreekt met de werkplekbegeleider.",
